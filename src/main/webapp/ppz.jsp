...
<div id="page">
    <div id="header">
        <div class="top">
            ...
            <a class="version new" href="http://wiki.ued.taobao.net/doku.php?id=user:zhangting:tools:ucool-pro:history:start" target="_blank" title="what's new?">ucool-pro version：0.9.3 <i>?</i></a>
        </div>
    </div>
    <div id="content">
